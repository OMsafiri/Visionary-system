...
$sql="SELECT tbl_contributions.id,tbl_contributions.amount,tbl_contributions.createdAt,tbl_users.firstname,tbl_users.middleName,tbl_users.lastName,`tbl_categories`.`name` FROM tbl_contributions INNER JOIN tbl_users ON tbl_contributions.user_id=tbl_users.id INNER JOIN tbl_categories ON tbl_contributions.category_id=tbl_categories.id";
