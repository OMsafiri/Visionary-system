...
if(isset($_POST['submit'])){
	...
	if(isset($_SERVER['REQUEST_METHOD']) == 'POST'){
		...
		$expenses_for = $_POST['expenses_for'];
		...
		if (empty($source) && empty($amount)) {
			...
			$query = "INSERT INTO expenses(expesnses_for,description,amount) VALUES(?,?,?)";
			$stmt = $instance->prepare($query);
			$stmt->bind_param("ssi", $expenses_for, $description, $amount);
			$stmt->execute();
				...
				<div class="col-md-8 my-4">
					<div class="row">
						<div class="col-md-12 my-4">
							...
							<h6 class="text-muted">Add Expenses .</h6>
						</div>
						<div class="col-md-12">
							<form method="POST" action="" autocomplete="off">
								...
								<div class="row">
									<div class="col-4">
										<div class="mb-4">
											<label for="expenses_for">Expenses For</label>
											<input type="text" name="expenses_for" id="expenses_for" class="form-control">
										</div>
									</div>
